...
public abstract class WebCrawlerParser {
	 ...
	 * @throws IOException
	 */
	public Elements getElementsInPage(String webLink,
			String... selectFilterQuery) throws IOException {
	...
	/**
	 * This method is to get all sub element in Page Elements based on css
	 * filter queries
	 * 
	 * @param elements
	 *            , linkFilterCond
	 ...
	 * @throws IOException
	 */
	public List<Elements> getSubElements(Elements elements,
			String... linkFilterCond) throws IOException {
		List<Elements> mailEelementsList = new ArrayList<Elements>();
		for (Element link : elements) {
			mailEelementsList.add(getElementsInPage(
					link.absUrl(CrawlerConstants.LINK_TAG), linkFilterCond));
		}
		return mailEelementsList;
	}
	 ...
	 * @return mailLinkList
	 */
	public static Set<String> getLinksFromPageElements(Elements elements,
			String linkFilterCond) throws IOException {
		Set<String> mailLinkSet = new HashSet<String>();
		for (Element link : elements) {
			if (linkFilterCond == null
					|| link.attr(CrawlerConstants.LINK_TAG).contains(
							linkFilterCond))
	...
	public static Elements parseForAnchors(Document doc) {
